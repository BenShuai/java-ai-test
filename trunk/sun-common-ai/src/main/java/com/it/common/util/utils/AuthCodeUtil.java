...
public class AuthCodeUtil {
    ...
    private static int height = 37;// 定义图片的height
    ...
    public static Map<String,Object> getAuthCode() throws Exception{
        Map<String,Object> map = AuthCodeUtil.generateCodeAndPic();
        BufferedImage codePic = (BufferedImage)map.get("codePic");
        ByteArrayOutputStream os = new ByteArrayOutputStream();
        ImageIO.write(codePic, "png", os);
        InputStream is = new ByteArrayInputStream(os.toByteArray());

        String base64Img = "data:image/png;base64," + BaseUtil.getBase64FromInputStream(is);

        map.remove("codePic");
        map.put("codePic",base64Img);
        return map;
    }
