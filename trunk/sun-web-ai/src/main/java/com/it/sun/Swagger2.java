...
public class Swagger2 {
    ...
    private ApiInfo apiInfo() {
        return new ApiInfoBuilder()
                .title("创互地图开放平台-API文档")
                .description("深圳市创互科技有限公司")
                .termsOfServiceUrl("https://openapi.cloudindoormap.com:8888/")
                .contact(new Contact("lenleicool#163.com", "https://www.chaunve.com/", "lenleicool#163.com"))
                .version("1.2.18")
                .build();
    }
